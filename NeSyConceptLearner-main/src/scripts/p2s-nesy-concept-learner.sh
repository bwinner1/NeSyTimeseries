...
CUDA_VISIBLE_DEVICES=$DEVICE python nesy_cl_p2s.py --dataset p2s --concept sax --n-segments 6 --alphabet-size 6 \
--epochs 50 --name $MODEL --lr 0.0001 --batch-size 16 --seed 0 --num-workers 4 --mode train --no-cuda
